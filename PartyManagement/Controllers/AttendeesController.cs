...
namespace Party_Management.Controllers
{
    public class AttendeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Name,Phone,email,password")] Attendee attendee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Name,Phone,email,password")] Attendee attendee)
        {
            if (ModelState.IsValid)
            {
